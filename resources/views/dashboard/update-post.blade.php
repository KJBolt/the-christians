            ...
            <div class="card">
                ...
                <div class="content">
                    ...
                    <form action="{{ route('post.update',$post) }}" method="post" enctype="multipart/form-data">
                        ...
                        <textarea id="body" name="body" cols="30" rows="5" class="form-control" placeholder="Enter body here..">{{ $post->body }}</textarea>
                        @error('body')
                            <p style="color: red">{{ $message }}</p>
                        @enderror
                        <div class="button col-lg-12 col-md-12 col-sm-12">
                            <input type="submit" value="Update" class="btn col-lg-6 col-md-6 col-sm-6">
                        </div>
                    </form>
